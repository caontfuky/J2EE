<%-- 
    ...
    Created on : Jun 3, 2016, 10:35:00 PM
    Author     : BLAMAN
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        ...
                        <%
                            ...
                            Object obj = request.getParameter("ProductID");
                            if(obj != null)
                            {
                                p = model.getProductByID(Integer.parseInt(obj.toString()));
                            }
                           
                        %>
                            <div class="col-sm-5">
                                <div class="view-product">
                                    <img src="<%=request.getContextPath()%>/images/product-details/1.jpg" alt="" />
                                </div>
                            ...
                            <div class="col-sm-7">
                                <div class="product-information"><!--/product-information-->
                                    <img src="<%=request.getContextPath()%>/images/product-details/new.jpg" class="newarrival" alt="" />
                                    <h2><%=p.getName() %></h2>
                                    <p>Web ID: <%=p.getProId()%></p>
                                    <span>
                                        <span><%=p.getCostMoney()%></span>
                                    </span>
                                    ...
                                    <span>
                                        <form action="addItem" method="post">
                                            ...
                                            <input type="hidden" value=<%=p.getProId()%> name="ProductID"/>
